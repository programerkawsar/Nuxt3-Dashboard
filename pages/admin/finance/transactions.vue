  ...
  <v-sheet color="transparent" class="mx-auto" :max-width="1000">
    <div class="mb-6 mb-md-12 text-black">
      <h3 class="text-body-1 font-weight-bold">
        {{ $t('page.financeTransactions.title') }}
      </h3>
      <p class="text-body-2 text-medium-emphasis">
        {{ $t('page.financeTransactions.subtitle') }}
      </p>
    </div>
...
const {
  ...
  data: apiData,
  refresh: refreshData,
} = await useFetch('https://dummyjson.com/c/ee26-cdde-4eba-b12a', {
  lazy: true,
})
...
useHead({
  title: t('page.financeTransactions.head.title'),
