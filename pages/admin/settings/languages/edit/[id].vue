  ...
  <v-sheet color="transparent" class="mx-auto" :max-width="500">
    <div class="mb-12 text-black">
      <h3 class="text-body-1 mb-1 font-weight-bold">
        {{ $t('page.updateLanguage.title') }}
      </h3>
      <p class="text-body-2 text-medium-emphasis">
        {{ $t('page.updateLanguage.subtitle') }}
      </p>
    </div>
    ...
    <v-form ref="form" class="position-relative" @submit.prevent="submit">
      <v-row>
        <v-col cols="12">
          <v-row>
            <v-col cols="12" md="6">
...
useHead({
  title: t('page.updateLanguage.head.title'),
