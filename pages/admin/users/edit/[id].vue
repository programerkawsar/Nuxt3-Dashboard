  ...
  <v-sheet color="transparent" class="mx-auto" :max-width="500">
    <div class="mb-12 text-black">
      <h3 class="text-body-1 mb-1 font-weight-bold">
        {{ $t('page.updateUser.title') }}
      </h3>
      <p class="text-body-2 text-medium-emphasis">
        {{ $t('page.updateUser.subtitle') }}
      </p>
    </div>
...
useHead({
  title: t('page.updateUser.head.title'),
...
const validationRules = reactive({
  ...
  min: (v: string) =>
    !v || v.length >= 8 || t('validationMessage.minCharacters', { num: 8 }),
  matches: () =>
    confirmPassword.value === password.value || t('validationMessage.matches'),
})
